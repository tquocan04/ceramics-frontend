/** §16.3 — POST /api/batches/:batchId/stages/:stage/fail */
...
import { failStage } from "@/lib/mock/services"
...
export async function POST(request: Request, ctx: Ctx) {
  ...
  return handle(() => failStage(id, parseStage(stage), body.reason ?? "Không rõ nguyên nhân"))
}
