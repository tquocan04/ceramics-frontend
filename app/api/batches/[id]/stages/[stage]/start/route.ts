/** §16.3 — POST /api/batches/:batchId/stages/:stage/start */
...
import { startStage } from "@/lib/mock/services"
...
export async function POST(request: Request, ctx: Ctx) {
  ...
  return handle(() => startStage(id, parseStage(stage), { note: body.note ?? null }))
}
