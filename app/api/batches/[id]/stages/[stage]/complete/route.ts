/** §16.3 — POST /api/batches/:batchId/stages/:stage/complete */
...
import { completeStage } from "@/lib/mock/services"
...
export async function POST(request: Request, ctx: Ctx) {
  ...
  return handle(() => completeStage(id, parseStage(stage), { note: body.note ?? null }))
}
